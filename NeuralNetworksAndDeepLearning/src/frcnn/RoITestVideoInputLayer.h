...
public:
	...
	public:
		...
		virtual Builder* fps(const int fps) {
			this->_fps = fps;
			return this;
		}
		virtual Builder* videoPath(const std::string& videoPath) {
			this->_videoPath = videoPath;
			return this;
		}
		Layer<Dtype>* build() {
			SASSERT0(!this->_videoPath.empty());
			return new RoITestVideoInputLayer(this);
		}
	};

	RoITestVideoInputLayer(Builder* builder);
