...
public:
	...
	static typename Layer<Dtype>::Builder* create(
        typename Layer<Dtype>::LayerType layerType) {
		switch(layerType) {
		case Layer<Dtype>::Input: return new typename InputLayer<Dtype>::Builder();
		case Layer<Dtype>::FullyConnected: 
            return new typename FullyConnectedLayer<Dtype>::Builder();
		...
		case Layer<Dtype>::DepthConcat:
            return new typename DepthConcatLayer<Dtype>::Builder();
