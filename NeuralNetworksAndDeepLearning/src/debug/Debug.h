...
LayersConfig<Dtype>* createFrcnnTrainOneShotLayersConfig() {
	...
	LayersConfig<Dtype>* layersConfig =
			...
			// 실제 input data에 대한 cls score, bbox pred를 계산,
			// LOSS를 계산할 때 쓸 데이터를 생성한다.
			...
			->layer((new typename FullyConnectedLayer<Dtype>::Builder())
					...
					->weightUpdateParam(1, 1)
					->biasUpdateParam(bias_lr, 1)
					->weightFiller(ParamFillerType::Gaussian, 0.001)
					->biasFiller(ParamFillerType::Constant, 0.0)
					->inputs({"fc7"})
					->outputs({"bbox_pred"}))
			->layer((new typename SoftmaxWithLossLayer<Dtype>::Builder())
			...
			->layer((new typename SmoothL1LossLayer<Dtype>::Builder())
					...
					->lossWeight(1.0f)
					//->firstAxis(2)
					->inputs({"bbox_pred", "bbox_targets", "bbox_inside_weights",
						"bbox_outside_weights"})
					->outputs({"loss_bbox"})
					->propDown({true, true, false, false}))
			->build();
...
LayersConfig<Dtype>* createFrcnnTestOneShotLayersConfig() {
	LayersConfig<Dtype>* layersConfig =
			...
			->layer((new typename RoITestInputLayer<Dtype>::Builder())
					...
					->imageSet("test")
					->dataName("idis")
					->dataPath("/home/jkim/Dev/data/object_detection/idis")
					//->dataName("voc_2007")
					//->dataPath("/home/jkim/Dev/git/py-faster-rcnn/data/VOCdevkit2007/VOC2007")
					->labelMapPath("/home/jkim/Dev/git/py-faster-rcnn/data/VOCdevkit2007/labelmap_voc.prototxt")
			...
			->layer((new typename ProposalLayer<Dtype>::Builder())
					...
					->featStride(16)
					->inputs({"rpn_cls_prob_reshape", "rpn_bbox_pred", "im_info"})
					->outputs({"rois"})							// different with train
					->propDown({false, false, false}))
			...
			->layer((new typename FrcnnTestOutputLayer<Dtype>::Builder())
					...
					->labelMapPath("/home/jkim/Dev/git/py-faster-rcnn/data/VOCdevkit2007/labelmap_voc.prototxt")
					->thresh(0.5)
					->savePath("/home/jkim/frcnn/outputs")
...
template <typename Dtype>
LayersConfig<Dtype>* createFrcnnVideoTestOneShotLayersConfig() {
	LayersConfig<Dtype>* layersConfig =
			(new typename LayersConfig<Dtype>::Builder())
			->layer((new typename RoITestVideoInputLayer<Dtype>::Builder())
					->id(0)
					->name("input-data")
					->numClasses(21)
					->pixelMeans({102.9801f, 115.9465f, 122.7717f})	// BGR
					->videoPath("/home/jkim/frcnn/videos/frcnn.mp4")
					->outputs({"data", "im_info", "raw_im"}))
			...
			->layer((new typename FrcnnTestVideoOutputLayer<Dtype>::Builder())
					->id(350)
					->name("test_output")
					->labelMapPath("/home/jkim/Dev/git/py-faster-rcnn/data/VOCdevkit2007/labelmap_voc.prototxt")
					->thresh(0.7)
					//->savePath("/home/jkim/test_output")
					->inputs({"rois", "im_info", "cls_prob", "bbox_pred", "raw_im"}))
...
template <typename Dtype>
LayersConfig<Dtype>* createSSDNetLayersConfig() {
	const float bias_const = 0.0f;

	LayersConfig<Dtype>* layersConfig = (new typename LayersConfig<Dtype>::Builder())
			->layer((new typename AnnotationDataLayer<float>::Builder())
					->id(0)
					->name("data")
					->flip(false)
					->imageHeight(300)
			...
			//---for conv4_3
			->layer((new typename NormalizeLayer<Dtype>::Builder())
					->id(520)
					->name("conv4_3_norm")
					->acrossSpatial(false)
					->channelShared(false)
					->scaleFiller(ParamFillerType::Constant, 20.0)
					->scaleUpdateParam(1.0, 1.0)
					->inputs({"conv4_3"})
			...
			->layer((new typename ConvLayer<Dtype>::Builder())
					...
					->filterDim(3, 3, 512, 16, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv4_3_norm"})
					->outputs({"conv4_3_norm_mbox_loc"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(540)
			...
			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(550)
			...
			->layer((new typename ConvLayer<Dtype>::Builder())
					...
					->filterDim(3, 3, 512, 84, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv4_3_norm"})
					->outputs({"conv4_3_norm_mbox_conf"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(570)
					->name("conv4_3_norm_mbox_conf_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv4_3_norm_mbox_conf"})
					->outputs({"conv4_3_norm_mbox_conf_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(580)
					->name("conv4_3_norm_mbox_conf_flat")
					->axis(1)
					->inputs({"conv4_3_norm_mbox_conf_perm"})
					->outputs({"conv4_3_norm_mbox_conf_flat"}))

			->layer((new typename PriorBoxLayer<Dtype>::Builder())
					->id(590)
					...
					->flip(true)
					->clip(false)
					->variances({0.10000000149, 0.10000000149, 0.20000000298, 0.20000000298})
					->step(8.0)
					->offset(0.5)
			...
			->layer((new typename ConvLayer<Dtype>::Builder())
					->id(600)
					->name("fc7_mbox_loc")
					->filterDim(3, 3, 1024, 24, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"fc7"})
					->outputs({"fc7_mbox_loc"}))
			...
			->layer((new typename PermuteLayer<Dtype>::Builder())
					...
					->orders({0, 2, 3, 1})
					->inputs({"fc7_mbox_loc"})
					->outputs({"fc7_mbox_loc_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(620)
					->name("fc7_mbox_loc_flat")
					->axis(1)
					->inputs({"fc7_mbox_loc_perm"})
					->outputs({"fc7_mbox_loc_flat"}))

			->layer((new typename ConvLayer<Dtype>::Builder())
					->id(630)
					->name("fc7_mbox_conf")
					->filterDim(3, 3, 1024, 126, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"fc7"})
					->outputs({"fc7_mbox_conf"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(640)
					->name("fc7_mbox_conf_perm")
					->orders({0, 2, 3, 1})
					->inputs({"fc7_mbox_conf"})
					->outputs({"fc7_mbox_conf_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(650)
					->name("fc7_mbox_conf_flat")
					->axis(1)
					->inputs({"fc7_mbox_conf_perm"})
					->outputs({"fc7_mbox_conf_flat"}))
			...
			->layer((new typename ConvLayer<Dtype>::Builder())
					...
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv6_2"})
					->outputs({"conv6_2_mbox_loc"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(670)
					->name("conv6_2_mbox_loc_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv6_2_mbox_loc"})
					->outputs({"conv6_2_mbox_loc_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(680)
					->name("conv6_2_mbox_loc_flat")
					->axis(1)
					->inputs({"conv6_2_mbox_loc_perm"})
					->outputs({"conv6_2_mbox_loc_flat"}))

			->layer((new typename ConvLayer<Dtype>::Builder())
					->id(690)
					->name("conv6_2_mbox_conf")
					->filterDim(3, 3, 512, 126, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv6_2"})
					->outputs({"conv6_2_mbox_conf"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(700)
					->name("conv6_2_mbox_conf_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv6_2_mbox_conf"})
					->outputs({"conv6_2_mbox_conf_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(710)
					->name("conv6_2_mbox_conf_flat")
					->axis(1)
					->inputs({"conv6_2_mbox_conf_perm"})
					->outputs({"conv6_2_mbox_conf_flat"}))
			...
			->layer((new typename PriorBoxLayer<Dtype>::Builder())
					...
					->offset(0.5)
					->inputs({"conv6_2", "data"})
					->outputs({"conv6_2_mbox_priorbox"}))

			//---for conv7_2
			->layer((new typename ConvLayer<Dtype>::Builder())
					->id(730)
					->name("conv7_2_mbox_loc")
					->filterDim(3, 3, 256, 24, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv7_2"})
					->outputs({"conv7_2_mbox_loc"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(740)
					->name("conv7_2_mbox_loc_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv7_2_mbox_loc"})
					->outputs({"conv7_2_mbox_loc_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(750)
					->name("conv7_2_mbox_loc_flat")
					->axis(1)
					->inputs({"conv7_2_mbox_loc_perm"})
					->outputs({"conv7_2_mbox_loc_flat"}))

			->layer((new typename ConvLayer<Dtype>::Builder())
					->id(760)
					->name("conv7_2_mbox_conf")
					->filterDim(3, 3, 256, 126, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv7_2"})
					->outputs({"conv7_2_mbox_conf"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(770)
					->name("conv7_2_mbox_conf_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv7_2_mbox_conf"})
					->outputs({"conv7_2_mbox_conf_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(780)
					->name("conv7_2_mbox_conf_flat")
					->axis(1)
					->inputs({"conv7_2_mbox_conf_perm"})
					->outputs({"conv7_2_mbox_conf_flat"}))
			...
			->layer((new typename PriorBoxLayer<Dtype>::Builder())
					...
					->offset(0.5)
					->inputs({"conv7_2", "data"})
					->outputs({"conv7_2_mbox_priorbox"}))

			//---for conv8_2
			->layer((new typename ConvLayer<Dtype>::Builder())
					->id(800)
					->name("conv8_2_mbox_loc")
					->filterDim(3, 3, 256, 16, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv8_2"})
					->outputs({"conv8_2_mbox_loc"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(810)
					->name("conv8_2_mbox_loc_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv8_2_mbox_loc"})
					->outputs({"conv8_2_mbox_loc_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(820)
					->name("conv8_2_mbox_loc_flat")
					->axis(1)
					->inputs({"conv8_2_mbox_loc_perm"})
					->outputs({"conv8_2_mbox_loc_flat"}))

			->layer((new typename ConvLayer<Dtype>::Builder())
					->id(830)
					->name("conv8_2_mbox_conf")
					->filterDim(3, 3, 256, 84, 1, 1)
					->weightUpdateParam(1, 1)
					->biasUpdateParam(2, 0)
					->weightFiller(ParamFillerType::Xavier, 0.1)
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv8_2"})
					->outputs({"conv8_2_mbox_conf"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(840)
					->name("conv8_2_mbox_conf_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv8_2_mbox_conf"})
					->outputs({"conv8_2_mbox_conf_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(850)
					->name("conv8_2_mbox_conf_flat")
					->axis(1)
					->inputs({"conv8_2_mbox_conf_perm"})
					->outputs({"conv8_2_mbox_conf_flat"}))
			...
			->layer((new typename ConvLayer<Dtype>::Builder())
					...
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv9_2"})
					->outputs({"conv9_2_mbox_loc"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(880)
					->name("conv9_2_mbox_loc_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv9_2_mbox_loc"})
					->outputs({"conv9_2_mbox_loc_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(890)
					->name("conv9_2_mbox_loc_flat")
					->axis(1)
					->inputs({"conv9_2_mbox_loc_perm"})
					->outputs({"conv9_2_mbox_loc_flat"}))
			...
			->layer((new typename ConvLayer<Dtype>::Builder())
					...
					->biasFiller(ParamFillerType::Constant, bias_const)
					->inputs({"conv9_2"})
					->outputs({"conv9_2_mbox_conf"}))

			->layer((new typename PermuteLayer<Dtype>::Builder())
					->id(910)
					->name("conv9_2_mbox_conf_perm")
					->orders({0, 2, 3, 1})
					->inputs({"conv9_2_mbox_conf"})
					->outputs({"conv9_2_mbox_conf_perm"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(920)
					->name("conv9_2_mbox_conf_flat")
					->axis(1)
					->inputs({"conv9_2_mbox_conf_perm"})
					->outputs({"conv9_2_mbox_conf_flat"}))
			...
			->layer((new typename PriorBoxLayer<Dtype>::Builder())
					...
					->offset(0.5)
					->inputs({"conv9_2", "data"})
					->outputs({"conv9_2_mbox_priorbox"}))

			->layer((new typename ConcatLayer<Dtype>::Builder())
					->id(940)
					->name("mbox_loc")
					->axis(1)
					->propDown({true, true, true, true, true, true})
					->inputs({"conv4_3_norm_mbox_loc_flat", "fc7_mbox_loc_flat",
			...
			->layer((new typename ConcatLayer<Dtype>::Builder())
					...
					->axis(1)
					->propDown({true, true, true, true, true, true})
					->inputs({"conv4_3_norm_mbox_conf_flat", "fc7_mbox_conf_flat",
							"conv6_2_mbox_conf_flat", "conv7_2_mbox_conf_flat",
							"conv8_2_mbox_conf_flat", "conv9_2_mbox_conf_flat"})
					->outputs({"mbox_conf"}))
			...
			->layer((new typename ConcatLayer<Dtype>::Builder())
					...
					->name("mbox_priorbox")
					->axis(1)
					->propDown({false, false, false, false, false, false})
					->inputs({"conv4_3_norm_mbox_priorbox", "fc7_mbox_priorbox",
							"conv6_2_mbox_priorbox", "conv7_2_mbox_priorbox",
							"conv8_2_mbox_priorbox", "conv9_2_mbox_priorbox"})
					->outputs({"mbox_priorbox"}))

			->layer((new typename MultiBoxLossLayer<Dtype>::Builder())
					->id(970)
					->name("mbox_loss")
...
template <typename Dtype>
LayersConfig<Dtype>* createSSDNetTestLayersConfig() {
	const float bias_const = 0.0f;
	...
	LayersConfig<Dtype>* layersConfig = (new typename LayersConfig<Dtype>::Builder())
			->layer((new typename AnnotationDataLayer<float>::Builder())
					...
					->imageHeight(300)
					->imageWidth(300)
					//->imageSetPath("/home/jkim/Dev/git/caffe_ssd/data/VOC0712/test.txt")
					//->baseDataPath("/home/jkim/Dev/git/caffe_ssd/data/VOCdevkit/")
					//->labelMapPath("/home/jkim/Dev/git/caffe_ssd/data/VOC0712/labelmap_voc.prototxt")
					->imageSetPath("/home/jkim/Dev/git/caffe_ssd/data/IDIS/test.txt")
					->baseDataPath("/home/jkim/Dev/git/caffe_ssd/data/VOCdevkit/")
					->labelMapPath("/home/jkim/Dev/git/caffe_ssd/data/IDIS/labelmap_voc.prototxt")
					->pixelMeans({104.f, 117.f, 123.f})	// BGR
					->shuffle(false)
					->outputs({"data", "label"}))
			// tier 1
			...
			->layer((new typename SoftmaxLayer<Dtype>::Builder())
					...
					->outputs({"mbox_conf_softmax"}))

			->layer((new typename FlattenLayer<Dtype>::Builder())
					->id(990)
					->name("mbox_conf_flatten")
					->axis(1)
					->inputs({"mbox_conf_softmax"})
					->outputs({"mbox_conf_flatten"}))

			->layer((new typename DetectionOutputLayer<Dtype>::Builder())
					->id(1000)
					->name("detection_out")
					->numClasses(21)
					->shareLocation(true)
					...
					->outputDirectory("/home/jkim/Dev/data/ssd/data/VOCdevkit/results/IDIS/SSD_300x300/Main")
					...
					->labelMapFile("/home/jkim/Dev/git/caffe_ssd/data/IDIS/labelmap_voc.prototxt")
					->nameSizeFile("/home/jkim/Dev/git/caffe_ssd/data/IDIS/test_name_size.txt")
					//->numTestImage(4952)
					->numTestImage(2400)
					//->numTestImage(3)
					->codeType("CENTER_SIZE")
			...
			->layer((new typename DetectionEvaluateLayer<Dtype>::Builder())
					->id(1010)
					->name("detection_eval")
					->numClasses(21)
					->backgroundLabelId(0)
